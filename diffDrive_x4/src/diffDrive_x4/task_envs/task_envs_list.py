...
def RegisterOpenAI_Ros_Env(task_env, max_episode_steps=10000):
    ...
    if task_env == '4WDDPracticeWorld-v0':

        register(id=task_env,
		 entry_point='diffDrive_x4.task_envs.diff_drive.4WDD_world:4WDDWorldEnv',
                 max_episode_steps=max_episode_steps)

        # import our training environment
        from diffDrive_x4.task_envs.diff_drive import 4WDD_world
